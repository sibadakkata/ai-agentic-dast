...
| **Platform Authentication** | **SSO (canonical):** SAML 2.0 via Microsoft Entra ID, invite/group-based onboarding, `admin` / `user` RBAC. **Automation only:** HTTP Basic Auth (`DAST_AUTH_*`) for API/scripts — not end-user login | [SSO setup & IdP handoff](docs/SSO.md) · [RBAC details](docs/SSO_RBAC.md) |
