...
The scanner is accessible at the base URL defined in the environment variable `SCANNER_URL` (default: `http://18.117.143.222:8080`). All API calls require Basic Auth with credentials from `SCANNER_USER` (default: `dast-admin`) and `SCANNER_PASS`.
