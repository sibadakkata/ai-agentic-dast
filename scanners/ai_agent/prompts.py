...
WEB_PHASES: list[ScanPhase] = [
    ...
    ScanPhase(
        ...
        prompt=(
            ...
            "STEP 5 — CREDENTIAL STUFFING: Try common passwords on known usernames:\n"
            "  admin/admin, admin/password, user/user123\n"
            "  Use inject_payload on login form or api_request on login API."
        ),
        applies_to="website",
    ),
    ScanPhase(
